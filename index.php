...
<div class="min-h-screen bg-gradient-to-br from-clinic-ivory via-white to-clinic-vanilla">
    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-8 sm:py-12">
        <div class="max-w-6xl mx-auto text-center w-full">
            ...
            <div class="mb-8 sm:mb-12 lg:mb-16">
                <div class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 mx-auto mb-4 sm:mb-6 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-clinic-blue to-clinic-tea shadow-xl sm:shadow-2xl flex items-center justify-center">
                ...
                <h1 class="text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-comfortaa font-bold text-clinic-dark mb-3 sm:mb-4 leading-tight">
                    CARE
                </h1>
                <p class="text-base sm:text-lg md:text-xl lg:text-2xl text-clinic-dark/70 font-poppins max-w-3xl mx-auto mb-2 px-4">
                    Clinic Administration of Records System
                </p>
                <p class="text-sm sm:text-base md:text-lg text-clinic-dark/60 font-poppins italic px-4">
                    A School Clinic management Information system - Live Update Test
                </p>
            </div>

            <!-- Features Grid -->
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12 px-4 sm:px-0">
                <div class="bg-white/80 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg sm:shadow-xl border border-clinic-tea/20 hover:shadow-xl sm:hover:shadow-2xl transition-all duration-300">
                    <div class="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 rounded-xl sm:rounded-2xl bg-clinic-blue/10 flex items-center justify-center">
                    ...
                    <h3 class="text-lg sm:text-xl font-semibold text-clinic-dark mb-2">Patient Management</h3>
                    <p class="text-sm sm:text-base text-clinic-dark/60">Comprehensive patient registration and medical record management</p>
                </div>

                <div class="bg-white/80 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg sm:shadow-xl border border-clinic-tea/20 hover:shadow-xl sm:hover:shadow-2xl transition-all duration-300">
                    <div class="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 rounded-xl sm:rounded-2xl bg-clinic-tea/20 flex items-center justify-center">
                        <svg class="w-6 h-6 sm:w-8 sm:h-8 text-clinic-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                    </div>
                    <h3 class="text-lg sm:text-xl font-semibold text-clinic-dark mb-2">Medical Records</h3>
                    <p class="text-sm sm:text-base text-clinic-dark/60">Digital medical history and form management system</p>
                </div>

                <div class="bg-white/80 backdrop-blur-md rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg sm:shadow-xl border border-clinic-tea/20 hover:shadow-xl sm:hover:shadow-2xl transition-all duration-300 sm:col-span-2 lg:col-span-1">
                    <div class="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-3 sm:mb-4 rounded-xl sm:rounded-2xl bg-clinic-vanilla/30 flex items-center justify-center">
                        <svg class="w-6 h-6 sm:w-8 sm:h-8 text-clinic-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                        </svg>
                    </div>
                    <h3 class="text-lg sm:text-xl font-semibold text-clinic-dark mb-2">Analytics & Logs</h3>
                    <p class="text-sm sm:text-base text-clinic-dark/60">Comprehensive reporting and activity tracking</p>
                </div>
            </div>

            <!-- Call to Action -->
            <div class="space-y-4 sm:space-y-6 px-4 sm:px-0">
                <h2 class="text-xl sm:text-2xl md:text-3xl font-semibold text-clinic-dark mb-3 sm:mb-4">
                    Ready to access the system?
                </h2>
                <p class="text-base sm:text-lg text-clinic-dark/60 mb-6 sm:mb-8 px-2">
    ...
    <!-- About Us Section -->
    <div class="py-12 sm:py-16 lg:py-20 bg-white/50 backdrop-blur-sm">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8 sm:mb-12 lg:mb-16">
                <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-comfortaa font-bold text-clinic-dark mb-4 sm:mb-6">
                    About Our School
                </h2>
                <div class="w-16 sm:w-20 lg:w-24 h-1 bg-gradient-to-r from-clinic-blue to-clinic-tea mx-auto rounded-full"></div>
            </div>
            
            <div class="space-y-8 sm:space-y-10 lg:space-y-12">
                <div class="text-center px-4 sm:px-0">
                    <h3 class="text-xl sm:text-2xl md:text-3xl font-semibold text-clinic-dark mb-4 sm:mb-6">
                        Our Lady of the Sacred Heart Inc.
                    </h3>
                    <p class="text-base sm:text-lg text-clinic-dark/70 leading-relaxed max-w-4xl mx-auto">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
                    <!-- Vision Card -->
                    <div class="bg-gradient-to-br from-clinic-blue/10 to-clinic-tea/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg sm:shadow-xl">
                        <div class="text-center">
                            <div class="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 sm:mb-6 rounded-full bg-gradient-to-br from-clinic-blue to-clinic-tea flex items-center justify-center">
                                <svg class="w-8 h-8 sm:w-10 sm:h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                </svg>
                            </div>
                            <h4 class="text-xl sm:text-2xl font-semibold text-clinic-dark mb-3 sm:mb-4">Vision</h4>
                            <p class="text-sm sm:text-base text-clinic-dark/70 italic leading-relaxed">
                    ...
                    <!-- Mission Card -->
                    <div class="bg-gradient-to-br from-clinic-tea/10 to-clinic-vanilla/20 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-lg sm:shadow-xl">
                        <div class="text-center">
                            <div class="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 sm:mb-6 rounded-full bg-gradient-to-br from-clinic-tea to-clinic-vanilla flex items-center justify-center">
                                <svg class="w-8 h-8 sm:w-10 sm:h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                                </svg>
                            </div>
                            <h4 class="text-xl sm:text-2xl font-semibold text-clinic-dark mb-3 sm:mb-4">Mission</h4>
                            <div class="text-sm sm:text-base text-clinic-dark/70 text-left space-y-2 sm:space-y-3">
                                <p class="italic leading-relaxed">
                                    "Inspired by and devoted to the Oneness of Heart of Jesus and Mary, OLSHCO is in mission to:"
                                </p>
                                <ol class="space-y-1 sm:space-y-2 text-xs sm:text-sm">
