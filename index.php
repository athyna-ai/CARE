    ...
    <div class="max-w-4xl mx-auto text-center">
        ...
        <div class="space-y-6">
            ...
            <div class="flex justify-center">
                <a href="login.php" class="inline-block px-12 py-5 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-bold text-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 flex items-center gap-4 border-2 border-blue-500">
