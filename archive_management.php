...
<div class="min-h-[calc(100vh-5rem)] w-full p-4 md:p-8">
    <div class="max-w-7xl mx-auto">
        <!-- Header -->
        <div class="mb-8">
            <!-- Back Button -->
            <div class="mb-4">
                <a href="dashboard.php" class="inline-flex items-center text-slate-600 hover:text-slate-800 transition-colors">
        ...
        <!-- Records Table -->
        <div class="bg-white/80 backdrop-blur border border-slate-200 rounded-2xl shadow-xl overflow-hidden">
