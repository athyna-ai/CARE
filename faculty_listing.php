...
// Get faculty
$sql = "SELECT * FROM faculty $whereClause ORDER BY name ASC LIMIT $perPage OFFSET $offset";
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <h1 class="text-3xl font-bold text-slate-800">Faculty Members</h1>
                    <p class="text-slate-600 mt-1">Manage faculty records and medical information</p>
                </div>
                <div class="flex items-center space-x-3">
                    <a href="faculty_form.php" class="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors flex items-center">
        ...
        <div class="bg-white rounded-lg shadow-sm border border-slate-200 overflow-hidden">
            <?php if (empty($faculty)): ?>
                <div class="text-center py-12">
                    ...
                    <a href="faculty_form.php" class="inline-flex items-center px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                        Add First Faculty
                    ...
                    <?php foreach ($faculty as $member): ?>
                        <div class="px-6 py-4 hover:bg-slate-50 transition-colors">
                            <div class="grid grid-cols-12 gap-4 items-center">
                                ...
                                <div class="col-span-2">
                                    <span class="text-sm text-slate-900"><?= $member['age'] ?> years</span>
                                </div>
                                <div class="col-span-2">
                                    <?php if ($member['sr']): ?>
                                ...
                                <div class="col-span-1">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <a href="faculty_form.php?id=<?= $member['id'] ?>" 
