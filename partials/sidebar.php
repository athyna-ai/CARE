...
<aside id="appSidebar" class="fixed top-20 left-0 z-30 h-[calc(100vh-4rem)] w-72 sm:w-80 bg-white/90 backdrop-blur-md border-r border-clinic-tea/20 shadow-xl transition-transform duration-300 ease-in-out -translate-x-full" data-sidebar-state="hidden">
	<nav class="p-4 sm:p-6 space-y-2 sm:space-y-3">
		...
		<div class="mb-4">
			<div class="space-y-2">
				<a href="<?= $basePath ?>admin/dashboard.php" class="group flex items-center gap-3 sm:gap-4 px-3 sm:px-5 py-2 sm:py-3 rounded-2xl bg-clinic-blue/10 border border-clinic-blue/20 text-clinic-blue hover:bg-clinic-blue/20 hover:border-clinic-blue/40 hover:shadow-lg transition-all duration-300">
					...
					<span class="font-poppins font-medium text-sm sm:text-base">Dashboard</span>
				</a>
			</div>
		</div>
		...
		<div class="mb-4">
			...
			<div class="space-y-2">
				<a href="<?= $basePath ?>rfid/rfid_portal.php" class="group flex items-center gap-3 sm:gap-4 px-3 sm:px-5 py-2 sm:py-3 rounded-2xl bg-clinic-ivory/60 border border-clinic-tea/20 text-clinic-blue hover:bg-clinic-blue/10 hover:border-clinic-blue/30 hover:shadow-lg transition-all duration-300">
					...
					<span class="font-poppins font-medium text-sm sm:text-base">Search</span>
				</a>
			</div>
		</div>
		...
		<div class="mb-4">
			...
			<div class="space-y-2">
				<a href="<?= $basePath ?>patients/student_form.php" class="group flex items-center gap-3 sm:gap-4 px-3 sm:px-5 py-2 sm:py-3 rounded-2xl bg-clinic-ivory/60 border border-clinic-tea/20 text-clinic-blue hover:bg-clinic-tea/20 hover:border-clinic-tea/40 hover:shadow-lg transition-all duration-300">
				...
				<a href="<?= $basePath ?>patients/faculty_form.php" class="group flex items-center gap-3 sm:gap-4 px-3 sm:px-5 py-2 sm:py-3 rounded-2xl bg-clinic-ivory/60 border border-clinic-tea/20 text-clinic-blue hover:bg-clinic-vanilla/30 hover:border-clinic-vanilla/40 hover:shadow-lg transition-all duration-300">
					...
					<span class="font-poppins font-medium text-sm sm:text-base">Register Faculty</span>
				</a>
			</div>
		</div>
		...
		<div class="mb-4">
			...
			<div class="space-y-2">
				<a href="<?= $basePath ?>admin/archive_management.php" class="group flex items-center gap-3 sm:gap-4 px-3 sm:px-5 py-2 sm:py-3 rounded-2xl bg-clinic-ivory/60 border border-clinic-tea/20 text-clinic-blue hover:bg-clinic-dark/5 hover:border-clinic-dark/20 hover:shadow-lg transition-all duration-300">
				...
				<a href="<?= $basePath ?>logs/visitation_logs.php" class="group flex items-center gap-3 sm:gap-4 px-3 sm:px-5 py-2 sm:py-3 rounded-2xl bg-clinic-ivory/60 border border-clinic-tea/20 text-clinic-blue hover:bg-clinic-green/5 hover:border-clinic-green/20 hover:shadow-lg transition-all duration-300">
				...
				<a href="<?= $basePath ?>logs/logs.php" class="group flex items-center gap-3 sm:gap-4 px-3 sm:px-5 py-2 sm:py-3 rounded-2xl bg-clinic-ivory/60 border border-clinic-tea/20 text-clinic-blue hover:bg-clinic-purple/5 hover:border-clinic-purple/20 hover:shadow-lg transition-all duration-300 relative">
				...
				<a href="<?= $basePath ?>reports/analytics.php" class="group flex items-center gap-3 sm:gap-4 px-3 sm:px-5 py-2 sm:py-3 rounded-2xl bg-clinic-ivory/60 border border-clinic-tea/20 text-clinic-blue hover:bg-clinic-orange/5 hover:border-clinic-orange/20 hover:shadow-lg transition-all duration-300">
				...
				<a href="<?= $basePath ?>admin/settings.php" class="group flex items-center gap-3 sm:gap-4 px-3 sm:px-5 py-2 sm:py-3 rounded-2xl bg-clinic-ivory/60 border border-clinic-tea/20 text-clinic-blue hover:bg-clinic-blue/5 hover:border-clinic-blue/20 hover:shadow-lg transition-all duration-300">
				...
				<a href="<?= $basePath ?>pages/about_us.php" class="group flex items-center gap-3 sm:gap-4 px-3 sm:px-5 py-2 sm:py-3 rounded-2xl bg-clinic-ivory/60 border border-clinic-tea/20 text-clinic-blue hover:bg-clinic-info/5 hover:border-clinic-info/20 hover:shadow-lg transition-all duration-300">
