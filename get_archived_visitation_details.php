...
try {
    ...
    // Get archived visitation details
    ...
    if (!$visit) {
        echo '<div class="text-center py-8 text-red-600">Archived visitation record not found</div>';
        exit;
    }
    ...
    $archivedAt = date('M j, Y g:i A', strtotime($visit['archived_at']));
    ...
    <div class="space-y-6">
        ...
        <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
            <div class="flex items-center gap-2">
                ...
                <p class="text-yellow-800 font-medium">This is an archived record. Archived on: ' . $archivedAt . '</p>
            </div>
        </div>
    ...
    error_log('Error fetching archived visitation details: ' . $e->getMessage());
