...
<div class="min-h-screen bg-gradient-to-br from-clinic-ivory via-white to-clinic-vanilla">
    ...
    <div class="bg-white/95 backdrop-blur-md shadow-xl border-b border-clinic-tea/20">
        <div class="w-full px-6 py-4">
            <!-- Back Button -->
            <div class="mb-4">
                <a href="patient_view.php?id=<?= $patientId ?>&type=<?= $patientType ?>" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-clinic-ivory/60 border border-clinic-tea/20 text-clinic-dark hover:bg-clinic-tea/20 hover:border-clinic-tea/40 transition-all duration-200 font-poppins font-medium">
...
function viewArchivedVisitationDetails(visitId, patientType) {
    ...
    // Load details
    fetch(`get_archived_visitation_details.php?id=${visitId}&type=${patientType}`)
